const calendar = document.querySelector(".calendar"),
  ...
  addEventPriority = document.querySelector(".event-priority"),
...
//only 50 chars in etitle
addEventTitle.addEventListener("input", (e) => {
  addEventTitle.value = addEventTitle.value.slice(0, 50);
});

//only 30 chars in priority
addEventPriority.addEventListener("input", (e) => {
    addEventPriority.value = addEventPriority.value.slice(0, 30);
});

//add time in correct format
...
addEventSubmit.addEventListener("click", () => {
  ...
  if (eventTitle === "" || eventTimeFrom === "" || eventTimeTo === "" || eventPriority === "") {
  ...
  if (timeFromArr.length !== 2 || timeToArr.length !== 2 || timeFromArr[0] > 23 || timeFromArr[1] > 59 || timeToArr[0] > 23 || timeToArr[1] > 59) {
    alert("Invalid Time Format, please enter correct times.");
    return;
  }
  ...
  //select active day and add event class
    ...
    if (confirm("Are you sure you want to delete this event?")) {
      ...
      eventsArr.forEach((event) => {
        if (event.day === activeDay && event.month === month + 1 && event.year === year) {
          ...
          //if no events left in a day - remove from eventsArr
